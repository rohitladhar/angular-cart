...
export class ProductService {
  ...
  constructor(private http:HttpClient) {}
    ...
    getCartItemsByCustId(custId:number){
      return this.http.get("https://onlinetestapi.gerasim.in/api/Ecomm/GetCartProductsByCustomerId?id="+custId);
    }
    
    removeCartItemById(cartId:number){
      return this.http.get("https://onlinetestapi.gerasim.in/api/Ecomm/DeleteProductFromCartById?id="+cartId);
    }
